        ...
        <div className="space-y-6">
            ...
            {/* Summary */}
             <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-3xl font-bold text-indigo-600">{formatCurrency(reportData.totalTurnover)}</p>
            </div>
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-4">Tren Omzet {timeFilterModeOpt.find(item => item.value === timeFilterMode).title}</h3>
                 <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={reportData.chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                        ...
                        <Legend />
                        <Line type="monotone" dataKey="omzet" stroke="#4f46e5" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} name="Omzet Penjualan"/>
                    </LineChart>
                </ResponsiveContainer>
            </div>
        </div>
